...
set output 'OdometryCMAES/parametersFullReads.pdf';
dataFile = 'OdometryCMAES/readsParametersLinearFullXYA.data';

set multiplot layout 3, 4 title 'Paramètres du modèle linéaire complet (proprioceptif)' font ',20';
set lmargin 6;
set rmargin 1;
set tmargin 2;
set bmargin 2;
